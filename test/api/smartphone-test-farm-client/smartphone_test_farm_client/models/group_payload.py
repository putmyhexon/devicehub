...
class GroupPayload:
    ...
    Attributes:
        ...
        class_ (Union[Unset, GroupPayloadClass]): Group class; privileged value => debug, bookable, standard Default:
            GroupPayloadClass.ONCE.
    ...
    class_: Union[Unset, GroupPayloadClass] = GroupPayloadClass.ONCE
