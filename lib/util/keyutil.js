...
const keyutil = Object.create(null)
keyutil.parseKeyCharacterMap = function(stream) {
    ...
    function fail(char, state) {
        throw new Error(util.format('Unexpected character "%s" in state "%s"', char, state))
    }
    function parse(char) {
        switch (state) {
...
keyutil.namedKey = function(name) {
    var key = adb.KeyCodes['KEYCODE_' + name.toUpperCase()]
    ...
    keymap.keys.forEach(function(key) {
        key.rules.forEach(function(rule) {
            ...
            var shouldHandle = rule.modifiers.every(function(modifier) {
                ...
                case 'shift':
                case 'lshift':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_SHIFT_LEFT)
                    combination.complexity += 10
                    return true
                case 'rshift':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_SHIFT_RIGHT)
                    combination.complexity += 10
                    return true
                case 'alt':
                case 'lalt':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_ALT_LEFT)
                    combination.complexity += 20
                    return true
                case 'ralt':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_ALT_RIGHT)
                    combination.complexity += 20
                    return true
                case 'ctrl':
                case 'lctrl':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_CTRL_LEFT)
                    combination.complexity += 20
                    return true
                case 'rctrl':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_CTRL_RIGHT)
                    combination.complexity += 20
                    return true
                case 'meta':
                case 'lmeta':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_META_LEFT)
                    combination.complexity += 20
                    return true
                case 'rmeta':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_META_RIGHT)
                    combination.complexity += 20
                    return true
                case 'sym':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_SYM)
                    combination.complexity += 10
                    return true
                case 'fn':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_FUNCTION)
                    combination.complexity += 30
                    return true
                case 'capslock':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_CAPS_LOCK)
                    combination.complexity += 30
                    return true
                case 'numlock':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_NUM_LOCK)
                    combination.complexity += 30
                    return true
                case 'scrolllock':
                    combination.modifiers.push(adb.KeyCodes.KEYCODE_SCROLL_LOCK)
                    combination.complexity += 30
                    return true
                }
            })
