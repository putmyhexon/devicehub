...
export const handler = function(argv) {
    ...
    function run() {
        var procs = [
            // app triproxy
            procutil.fork(path.join(__filename, '../index.js'), [
                'triproxy', 'app001'
            ...
            ].concat(JSON.parse(argv.authOptions))) // app
            ...
            ].concat(JSON.parse(argv.storageOptions))) // image processor
    ...
    return procutil.fork(path.join(import.meta.dirname, '../index.js'), ['migrate'])
        .done(run)
}
