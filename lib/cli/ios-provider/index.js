...
export const builder = function(yargs) {
    return yargs
        ...
        .option('udid-storage', {
            describe: 'The path for ip information of devices'
            , type: 'string'
            , default: false
        })
        .option('iproxy', {
...
export const handler = function(argv) {
    ...
    const [wdaPorts, screenWsPorts] = _.chunk(_.range(argv.portRangeMin, argv.portRangeMax), 2)
