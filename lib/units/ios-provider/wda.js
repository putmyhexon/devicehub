...
export class WDA {
    ...
    async startWda(udid) {
        ...
        const start = async() => {
            ...
            try {
                let testproc = childProcess.spawn(`xcodebuild -project WebDriverAgent.xcodeproj -scheme WebDriverAgentRunner -destination "id=${udid}" -allowProvisioningUpdates test`, {cwd: this.wdaPath, shell: true, stdio: 'pipe'})
