...
function createGroupFunc(res, _class, email, repetitions, name, username, privilege, isActive, dates, start, stop, duration, state) {
    checkSchedule(res, null, _class, email, repetitions, privilege, start, stop)
