...
const bannerutil = require('./util/banner')
const FrameParser = require('./util/frameparser')
const FrameConfig = require('./util/frameconfig')
const BroadcastSet = require('./util/broadcastset')
const StateQueue = require('../../../../util/statequeue')
const RiskyStream = require('../../../../util/riskystream')
const FailCounter = require('../../../../util/failcounter')
    ...
    return createServer()
      .then(function(wss) {
        ...
        var frameProducer = new FrameProducer(
          new FrameConfig(display.properties, display.properties, options.screenJpegQuality))
